...
const Header: React.FC = () => {
  ...
  return (
    <div className='bg-[rgb(131,182,94)] h-[5vh] flex flex-row px-5 py-2 items-center justify-center font-body font-poppins text-2xl text-white font-thin'>
      <h3 className='whitespace-nowrap'>Central BioHub<sup>©</sup> - Order Biospecimen Online</h3>
      <span className='relative block w-[100%] max-w-[800px] mx-[7%]'>
        <input className='bg-[#b5ceb0] w-[100%] text-black pl-10 pr-5 py-1 text-sm rounded-3xl placeholder:italic placeholder:text-slate-400 focus:outline-none my-1 drop-shadow-lg' placeholder='search...'></input>  

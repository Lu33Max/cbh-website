...
import { NormalFilterSchema, type INormalFilter, FilterType } from "~/common/filter/filter";
...
const ModalLoad: React.FC<CustomModalProps> = ({ showModal, setShowModal, setFilter }) => {
    ...
    function applyFilter() {
        if(selected){
            try {
                const parseFilter = NormalFilterSchema.parse(JSON.parse(selected.filter))
